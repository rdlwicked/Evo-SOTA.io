...
export default function MethodologyPage() {
    ...
    const texts = {
        en: {
            ...
            dataNoticeDesc2: 'If you find any errors or omissions, please let us know by creating an issue on GitHub. We will address them promptly.',
        },
        zh: {
            title: '方法说明',
            ...
            dataNoticeDesc2: '如有错误或遗漏，敬请谅解。您可以在 GitHub 的 Issue 中提出，我们会及时改进。',
        }
    };
